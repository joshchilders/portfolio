...
THEME_WORD_LIST  = {"office": ["MICHAEL", "DWIGHT", "JIM", "PAM", "ANDY", "STANLEY", "PHYLLIS", "ANGELA", "OSCAR", "KEVIN", "MEREDITH", "CREED", "RYAN", "KELLY", "TOBY", "DARRYL",
                    ...
                    "potter": ["HARRY", "RON", "HERMIONE", "GINNY", "HAGRID", "DUMBLEDORE", "MCGONAGALL", "DRACO", "SEVERUS", "VOLDEMORT", "SIRIUS", "HOGWARTS", "GRYFFINDOR", "HUFFLEPUFF", "RAVENCLAW", "SLYTHERIN",
                    "PADFOOT", "DOBBY", "TRELAWNEY", "FLITWICK", "UMBRIDGE", "MADEYE", "POMFREY", "SLUGHORN", "NEVILLE", "LUNA", "MYRTLE", "FILCH", "SNITCH", "WIZARD", "WITCH", "MAGIC"],
